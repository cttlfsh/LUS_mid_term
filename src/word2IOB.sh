...
#										INSTRUCTIONS 											#
#																								#
#	this script is the main script of the baseline project. It launches the right python 	 	#
#	script, train and test the transducer and evaluate the output:  							#
#																								#
#																								#
...
### .txt files
python scripts/W2IOB_processor.py $threshold 
